...
pv_power_a = Sensor("6380_40251E00_0", Identifier.pv_power_a, unit="W")
#: Current power generated by the solar panels (B side)
pv_power_b = Sensor("6380_40251E00_1", Identifier.pv_power_b, unit="W")
#: Current power generated by the solar panels (C side)
pv_power_c = Sensor("6380_40251E00_2", Identifier.pv_power_c, unit="W", enabled=False)
#: Current voltage generated by the solar panels (A side)
pv_voltage_a = Sensor(
    "6380_40451F00_0", Identifier.pv_voltage_a, unit="V", factor=100, enabled=False
)
#: Current voltage generated by the solar panels (B side)
pv_voltage_b = Sensor(
    "6380_40451F00_1", Identifier.pv_voltage_b, unit="V", factor=100, enabled=False
)
#: Current voltage generated by the solar panels (C side)
pv_voltage_c = Sensor(
    "6380_40451F00_2", Identifier.pv_voltage_c, unit="V", factor=100, enabled=False
)
#: Current amperage generated by the solar panels (A side)
pv_current_a = Sensor("6380_40452100_0", Identifier.pv_current_a, unit="A", factor=1000)
#: Current amperage generated by the solar panels (B side)
pv_current_b = Sensor("6380_40452100_1", Identifier.pv_current_b, unit="A", factor=1000)
...
insulation_residual_current = Sensor(
    "6102_40254E00", Identifier.insulation_residual_current, unit="mA", enabled=False
)
...
#: Power for phase 3
power_l3 = Sensor("6100_40464200", Identifier.power_l3, unit="W", enabled=False)

# AC Side - Grid measurements - Reactive power
#: Total Reactive Power
grid_reactive_power = Sensor(
    "6100_40265F00", Identifier.grid_reactive_power, unit="var", enabled=False
)
#: Reactive Power for phase 1
grid_reactive_power_l1 = Sensor(
    "6100_40666000", Identifier.grid_reactive_power_l1, unit="var", enabled=False
)
#: Reactive Power for phase 2
grid_reactive_power_l2 = Sensor(
    "6100_40666100", Identifier.grid_reactive_power_l2, unit="var", enabled=False
)
#: Reactive Power for phase 3
grid_reactive_power_l3 = Sensor(
    "6100_40666200", Identifier.grid_reactive_power_l3, unit="var", enabled=False
)

# AC Side - Grid measurements - Apparent power
#: Total Apparent Power
grid_apparent_power = Sensor(
    "6100_40666700", Identifier.grid_apparent_power, unit="VA", enabled=False
)
#: Apparent Power for phase 1
grid_apparent_power_l1 = Sensor(
    "6100_40666800", Identifier.grid_apparent_power_l1, unit="VA", enabled=False
)
#: Apparent Power for phase 2
grid_apparent_power_l2 = Sensor(
    "6100_40666900", Identifier.grid_apparent_power_l2, unit="VA", enabled=False
)
#: Apparent Power for phase 3
grid_apparent_power_l3 = Sensor(
    "6100_40666A00", Identifier.grid_apparent_power_l3, unit="VA", enabled=False
)
...
metering_active_power_draw_l1 = Sensor(
    "6100_0046EB00", Identifier.metering_active_power_draw_l1, unit="W"
)
#: Active Power drawn for phase 2 measured by energy meter
metering_active_power_draw_l2 = Sensor(
    "6100_0046EC00", Identifier.metering_active_power_draw_l2, unit="W"
)
#: Active Power drawn for phase 3 measured by energy meter
metering_active_power_draw_l3 = Sensor(
    "6100_0046ED00", Identifier.metering_active_power_draw_l3, unit="W"
)
...
pv_gen_meter = Sensor("6400_0046C300", Identifier.pv_gen_meter, unit="kWh", factor=1000)

# AC Side - Emergency power measurements (Secure Power Supply)
#: Secure power supply voltage
sps_voltage = Sensor(
    "6100_0046C600", Identifier.sps_voltage, unit="V", factor=100, enabled=False
)
#: Secure power supply current
sps_current = Sensor(
    "6100_0046C700", Identifier.sps_current, unit="A", factor=1000, enabled=False
)
#: Secure power supply power
sps_power = Sensor("6100_0046C800", Identifier.sps_power, unit="W", enabled=False)

# PV Inverter Optimizers
#: Serial number of optimizer
optimizer_serial = Sensor("6800_10852600", Identifier.optimizer_serial)
#: Power supplied by optimizer
optimizer_power = Sensor("6100_40652A00", Identifier.optimizer_power, unit="W")
#: Current supplied by optimizer
optimizer_current = Sensor(
    "6100_40652900", Identifier.optimizer_current, unit="A", factor=1000, enabled=False
)
#: Voltage supplied by optimizer
optimizer_voltage = Sensor(
    "6100_40652800", Identifier.optimizer_voltage, unit="V", factor=100, enabled=False
)
#: Temperature of optimizer
optimizer_temp = Sensor(
    "6100_40652B00", Identifier.optimizer_temp, unit="°C", factor=10, enabled=False
)
...
battery_voltage_c = Sensor(
    "6100_00495C00_2", Identifier.battery_voltage_c, unit="V", factor=100, enabled=False
)
#: Current battery A
battery_current_a = Sensor(
    "6100_40495D00_0", Identifier.battery_current_a, unit="A", factor=1000
)
#: Current battery B
...
battery_power_charge_a = Sensor(
    "6100_00499300_0", Identifier.battery_power_charge_a, unit="W", enabled=False
)
#: Charging power battery B
battery_power_charge_b = Sensor(
    "6100_00499300_1", Identifier.battery_power_charge_b, unit="W", enabled=False
)
#: Charging power battery C
battery_power_charge_c = Sensor(
    "6100_00499300_2", Identifier.battery_power_charge_c, unit="W", enabled=False
)
#: Total charge
...
battery_power_discharge_a = Sensor(
    "6100_00499400_0", Identifier.battery_power_discharge_a, unit="W", enabled=False
)
#: Disharging power battery B
battery_power_discharge_b = Sensor(
    "6100_00499400_1", Identifier.battery_power_discharge_b, unit="W", enabled=False
)
#: Disharging power battery C
battery_power_discharge_c = Sensor(
    "6100_00499400_2", Identifier.battery_power_discharge_c, unit="W", enabled=False
)
#: Total discharge
